Отличный выбор варианта! В этой задаче мы работаем с геоданными (координаты для поиска по радиусу), историей цен и пересечением дат (что является классической задачей для систем бронирования).
